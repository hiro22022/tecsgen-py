...
#
#   このファイルは tecslib/messages/messages_console_en_US.rb から
...
TECSMsg.error_message.update({
    ...
    "S1107": "to export port '$1', use 'cCall => composite.cCall'",
    ...
    "S1146": "$1: error occured while CPP(C-PreProcesor), please check C-compiler path or command line options",
    "S1147": "$1: popen for CPP(C-PreProcesor) failed, please check C-compiler path or command line options",
    ...
    "S2016": "'$1' can not be const for $2 parameter. This error can be eliminated by specifying [deviate] to signature",
...
TECSMsg.warning_message.update({
    ...
    "W3003": "$1 pointer level mismatch. This warning can be eliminated by specifying [deviate] to signature",
